...
import { PhoneCall, Mail, Lock, ArrowRight, Loader2, AlertCircle } from 'lucide-react';
    ...
    <div className="bg-zinc-950 min-h-screen text-white font-sans flex flex-col justify-center items-center px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 space-y-8">
        ...
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight pt-4">Welcome back</h2>
          <p className="text-sm text-zinc-400">Sign in to manage your autonomous AI workforce</p>
        </div>
